document.addEventListener('DOMContentLoaded', function () {
  ...
  projectsData.forEach(project => {
    ...
    const detailLink = project.detailPage || 'projects.html';
    ...
    if (project.githubLink && !project.underDevelopment) {
      projectCardHTML += `
          <a href="${project.githubLink}" target="_blank" class="btn btn-outline-dark position-relative" style="z-index: 2;" onclick="event.stopPropagation(); event.preventDefault(); window.open('${project.githubLink}', '_blank');">
